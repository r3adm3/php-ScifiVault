...
?>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>
		  <center><!-- ************* Table started for user/password or new user choice ****************** -->
		  <table cellpadding='20' border='1'> 
			<tr><td> 
				<center><b>Existing Customer?</b></center>
				
				<form action="AuthenticateUser.php" method="post">
	                    <center><table width='50%'><tr><font face="Verdana, Arial, Helvetica, sans-serif"><b><font size="2">
	                    <td>Email:</td></font>
	                    </b> <font size="2">
	                    <td><input type='text' name='EmailAddress' size='13'></td></tr>
						<input type='hidden' name='pagelink' value='Choose.php'>
	                    <font face="Verdana, Arial, Helvetica, sans-serif"><font size="2"><br>
	                    <b><td> Password: </td></b>
	                    <td><input type='password' name='Password' size='13'></td>
	                    </font>
	                    <tr><th colspan='2'><br><p align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
	                      <input type='image' src='images/buttons/SIGNBUTTON.gif' name='Sign In'>
	                      <a href="register.php"><img src="images/buttons/REGBUTTON.gif" border="0"></a></font><a href="register.php"></a></th></tr></table></center>
                  </form>
				
				</td>
				<td valign='top'> 
					<br><br><br><b><a href='ChooseDelivery2.php'>New Users click <br> here to continue</a></b>
				</td>
			</tr>
			</table><!-- ************* end Table started for user/password or new user choice ****************** --></center>
...
while ($line = mysql_fetch_array($strResult, MYSQL_ASSOC))
{
	...
	//display row.
	echo "<tr><td><form action='removeFromBasket.php' method='post'><input type='hidden' name='altRemove' value='-'><input type='hidden' name='page' value='" . $_SERVER['REQUEST_URI']. "'><input type='hidden' name='removeitem' value='" . $line["stockID"] . "'><INPUT TYPE='image' SRC='images/buttons/trash.gif' ALT='Remove' name='remove' value='-'></form></td>
	<td>". $line["qty"] . "</td>
	<td>" . $line["stockID"] . "</td>
	<td>" . $line["name"] . " </td>
...
$conNumberofRows = mysql_num_rows($strDeliveryResult);
	...
	//echo " 1stClassCost: " . $str1stClassCost . ", Insurance: " . $strInsurance . ", Weight: " . $totalWeight;

	//echo $str1stClassCost+0.68 . "<br>";

	echo "<tr><td></td><td></td><td></td><td>&nbsp;</td><td></td><td></td></tr>";
	echo "<tr><td></td><td></td><td></td><td><b>Shipping (" . $strShippingNote . ")</b></td><td></td><td align='right'>to be calculated</td></tr>";
	echo "<tr><td></td><td></td><td></td><td><b>Total</b></td><td></td><td align='right'>&pound;" . (sprintf ("%01.2f", $strShipping+$total)) . "</td></tr>";
...
?>
      <form action='submitOrder.php?strUserID=<?php echo $strUserID; ?>' method='POST'>
        <b>
        <?php
