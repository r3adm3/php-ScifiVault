...
";
    ...
    <td width="100%" align="center" valign="top">
      <p align="left"><b>Here is your order:</b>
        <?php
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>
            ...
            echo "</p>
            <p><a href='/UserDetails.php?strUserID=". $strUserID ."'>Change
          ...
          <tr>
            ...
            <td>
              <?php
				...
				elseif ($_GET['UserExistsError'] == 1)
				{
				echo "<input type='text' name='EmailAddress' size='20'><br><b><font color=red> This account already exists <br>Contact our support for help.</b></td>";
				}
...
$conNumberofRows = mysql_num_rows($strDeliveryResult);
	...
	echo "<tr><td></td><td></td><td></td><td><b>Total</b></td><td></td><td align='right'>&pound;" . (sprintf ("%01.2f", $total)) . "</td></tr>";
...
?>
	...
	funcDebug ($line2["PostCode"]);
 	if ($strAddressLine1 == "" or $strTown == "" or $strPostCode == "")
 	{

 		echo "\n<br><br>Incomplete delivery address, Please fill in details";
