...
?>
            ...
            <p><a href='/UserDetails.php?strUserID=<?php echo $strUserID; ?>'>Change
...
$conNumberofRows = mysql_num_rows($strDeliveryResult);
	...
	echo "<tr><td></td><td></td><td></td><td><b>Shipping (" . $strShippingNote . ")</b></td><td></td><td align='right'>&pound;" . sprintf ("%01.2f", $strShipping) . "</td></tr>";
