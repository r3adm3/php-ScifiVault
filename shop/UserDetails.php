...
<form method="POST" action="addDetails.php?strUserID=<?php echo $strUserID; ?>">
		...
		<table>
			...
			<tr><th colspan='2'> <input type='checkbox' name='emailUser' <?php if ($strMailUser == 'checked') {echo "checked='" . $strMailUser . "'";} ?>'>Recieve emails on Products <br> from Sci-Fi Vault<th></tr>
			<tr><th colspan='2' align='center'><input type="submit" value="Submit" name="B1"> </th></tr>
		</table>
	</form>
