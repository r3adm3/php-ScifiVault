...
";
    ...
    <td width="100%" align="center" valign="top">
      ...
      <P>
      <P>
      <P> <font size="4">Please sign-in <br>
        or <br>
        Register...</font>
      <FORM action="AuthenticateUser.php" method="post">


  <p>&nbsp;</p><table align="center" width="100%">
    <!--<tr>
						<td>Username: </td>
						<td><?php /*
						if ($_GET['UserPassError'] == 1)
						{
						echo "<b><font color=red> User or Password wrong! Please try again</b></font><br><input type='text' name='UserName' size='20'><br></td>";
						}
						else
						{
