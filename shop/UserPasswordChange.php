...
<P align="center">&nbsp;
      <table align="center">
        <form action="updatePassword.php?strUserID=<?php echo $strUserID; ?>" method="post">
          <tr>
            <td>Old Password: </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <?php
				...
				{
				echo "<input type='Password' name='Password3' size='20'><br><b><font color=red> Passwords do not match. </b></td>";
				}
				elseif ($_GET['PasswordError'] == 2)
				{
				echo "<input type='Password' name='Password3' size='20'><br><b><font color=red> Passwords must not contain any characters: ^<>`!#_-=|'+ </b></td>";
				}
				elseif ($_GET['PasswordError'] == 3)
				{
				echo "<input type='Password' name='Password3' size='20'><br><b><font color=red> There's more than one user with your User ID, please contact us immediately. This has been logged. </b></td>";
				}
				elseif ($_GET['PasswordError'] == 4)
				{
				echo "<input type='Password' name='Password3' size='20'><br><b><font color=red> Incorrect Password. Try Again. </b></td>";
				}
				else
				{
				echo "<input type='Password' name='Password3' size='20'></td>";
				}
				?>
          </tr>
          <tr>
...
if ($strUserID == "")
{
	?>
                  <form action="AuthenticateUser.php" method="post">
                    ...
                    <b> Password: </b> <br>
                    <input type='password' name='Password3' size='26'>
                    </font></font>
