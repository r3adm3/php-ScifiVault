...
";
    ...
    <td width="100%" align="center" valign="top"> 
      <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#002A54">
        <tr> 
          <td> 
            <p align="center"><font size="4">About Us...</font></p>
            <p>In a Galaxy far far away...........</p>
            <p>Well actually, right here on Planet Earth is where it all started.</p>
            <p>The year was 1977 and a film known as Star Wars was coming to the 
              Big Screen. </p>
            <p>We already had Star Trek. It could be funny, serious, and sad. 
              There was always some moral issue being fed to us, and the inevitable 
              guy in a red top who you knew was going to get it within minutes 
              of beaming down to the planets surface.</p>
            <p>What did Star Trek give us? It gave us memories, great ones at 
              that, but that was all. Star Wars was about to alter all of that.</p>
            <p>The film was released and suddenly the world changed literally 
              over night. It was described as being a Science Fiction film like 
              no other... and they were right it was amazing.<br>
            </p>
            <p>We had action figures of new creatures we had previously not known 
              the names of, hero's and villain's, robots, spaceships,weapons, 
              costumes, music, books, trading cards, shoes, pyjamas, mugs, plates, 
              cups, hats, glasses, watches, phones, kits, biscuits, lollies, postcards, 
              posters, pins, badges, coins, clocks. They were metal, plastic, 
              paper, wood, big, small, large, massive, huge. Did we mention the 
              toys??</p>
            <p>The list of items seemed to be endless and then we learnt that 
              in another country they had the same time but it was slightly different, 
              somehow better and we wanted them too. We wanted Vader with a different 
              card, the Death Star that was plastic with the lift and the garbage 
              crusher monster thingy that was green and looked nothing like the 
              one in the movie but it was COOOL and we wanted it. We WANTED EVERYTHING.</p>
            <p>Our life finally had purpose and that was to collect as much Star 
              Wars memorabilia as possible and beat everyone else.</p>
            <p>After that, they brought out more movies and more products - Oh 
              no, we didn't have enough money, what could we do? and to crown 
              it all, mum said that there was no more room in the bedroom, loft, 
              garage, spare room and last week she threw out all our comics as 
              we never look at them anymore. Nooooooooooooooooooo, luckily we 
              got to the bin before the rubbish man did, phew, that was close.</p>
            <p>So there were only three Star Wars movies and we'd managed to get 
              as much merchandise as possible. Mission accomplished, no more products 
              to get. We had down well young jedi, the force was strong with us!</p>
            <p>But wait, it's 1983 and suddenly more films were coming out, and 
              this time they had merchandise too; Star Trek, James Bond, Alien... 
              And what about all the stuff from the 70's from Thunderbirds and 
              Space 1999. Oh my goodness, there was so many more items to collect 
              that we loved.</p>
            <p>We are collectors who became traders as we wanted others to be 
              served the way we wanted to be served but often found that we weren't,</p>
            <p>We have a vast knowledge of collectibles across the Sci-Fi genre 
              and what we don't have we can get, what we don't know about, we 
              will find out about.</p>
            <p>Whether you are looking for old or new, something different, unique, 
              special or just your average Darth Vader on a card, we are here 
              to help you.</p>
            <p>We have been trading since 1989 and we're here to help you find 
              that little bit of Sci-Fi Magic.....</p>
            <p>For all your needs, we are here to help.</p>
            <p>Thank you for stopping by.</p>
            <p>May the force be with you and live long and prosper.</p>
            <p><i>Sci-Fi Vault Command</i></p>
            </td>
        </tr>
      </table>
      <br>
