	...
	if ($conNumberofRows != 1 )
	...
	else
		{
			...
			while ($row = mysql_fetch_array ($strResult))
			{
				...
				$strSTag = $row["SubjectTag"];
				$strCTag = $row["CategoryTag"];
				$strVTag = $row["VersionTag"];
...
//Title stuff. **************************************************************************************
		...
		*/
		...
		if ($strVTag == "ALL") {
		echo "\n<A href='subCategory.php?sTag=" . $strSTag . "&vTag=ALL'>" . $strUpCat . "</a> | <A href='subCategory2.php?sTag=" . $strSTag . "&vTag=" . $strVTag . "&cTag=" . $strCTag . "'>" . $strCategory. "</A>";} else
		{echo "<A href='Category.php?sTag=" . $strSTag . "'>" . $strUpCat . "</a> | <A href='subCategory.php?sTag=" . $strSTag . "&vTag=" . $strVTag . "'>" . $strCat . "</a> | <A href='subCategory2.php?sTag=" . $strSTag . "&vTag=" . $strVTag . "&cTag=" . $strCTag . "'>" . $strCategory. "</A>";}
...
<table width="100%" height="25" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#002A54">
        <tr>
		  ...
		  <img src="images/buttons/curveleft.gif" width="8" height="25" align="top">

          </td>
          <td bgcolor="#002A54" height="25">
            <div align="center"><font color="#FFFFFF"> <?php echo $strName; ?> </font></div>

          </td>
          <td width="8" height="25"><img src="images/buttons/curveright.gif" width="8" height="25" align="top"></td>
        </tr>
      </table>
      <table id="partial" width="100%" height="25" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#002A54">
        <tr>
          <td height="25">
            <div align="center">
			  <p><br>
                <img src='<?php echo $strLargePicture; ?>'> <br>
                <?php echo "<b><BR>" . $strShortDescription . "<br></b>"; ?>
              <br>
                <?php echo $strDescription;?>

              <p> <font color="#999999"><b><font size="1">
                <?echo "QuickFind code: " . $strStockID;?>
                <br>
                </font> </b></font></p>
              <p align="center"><b>
				...
				echo "RRP:&pound;<del>" . sprintf ("%01.2f",$strRRP) . "</del>";
				$strSaving = sprintf ("%01.2f",$strRRP - $strSaleRRP);
				echo "<br><font color='#FF0000'>Save: &pound;" . $strSaving ."</font>";
				echo "<br>Our Price: &pound;" . sprintf ("%01.2f",$strSaleRRP);
				...
				echo "<br>Our Price: &pound;" . $strRRP;
                ...
                elseif ($strNoOfItems==-1)
                {
                echo "Discontinued Item";
                }
                elseif ($strNoOfItems==-3)
                {
	                ...
	                if ($strUserID <> "")
	                {
				echo "Please enter the Quantity you would like to order and any comments below. These details will be added to your accounts Pre-Order list.  <br><br>When this item is in stock you will be sent a PayPal invoice to authorise the transaction.";
	
	                	echo "<p> <form action='UpdatePreOrder.php' method='post'>
							<table><tr><td>email:</td><td>
	                		<input type='text' name='emailforshow' size='20' value='" . $strUserID . "' disabled='disabled'></td></tr>
	                		<tr><td>Qty</td><td><input type='text' name ='preorderqty' size='5'></td></tr>
	                		<tr><td>Comment<td><textarea name='Comments' cols='20' rows='4'>&nbsp;</textarea></td></tr>
						</table>
						<input type='hidden' name='stockID' value='" . $strStockID . "'>
						<input type='hidden' name='email' value='" . $strUserID . "'>
						<input type='submit' name='Pre-order' value='Pre-Order'>
	                	</form>";
			}
			else
			{
			echo "This product is coming soon, and is currently available for pre-order." .
           	     	"<br> If interested, please sign in and revisit this page to place your order.";
			}
	
		// ***************** (END OF PRE ORDER STUFF) **********************************
                ...
                <input type='hidden' name='item' value='". $strStockID ."'>
                <input type='hidden' name='page' value= '" . $_SERVER['PHP_SELF'] . "?Item=$strStockID'>
                </form> </td></tr>";
                }
?>
              </p>
