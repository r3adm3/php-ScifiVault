...
";
    ...
    <td width="100%" align="center" valign="top">
      <p>What’s my password? If you have forgotten your password we can send you
        a new one to your registered email address. </p>
      <form  method="post" action="passwordRetrieval.php">
        Email address
        <p>
          <input type="text" name="email" maxlength="100" id="focusRequired" class="textarea" value="">
