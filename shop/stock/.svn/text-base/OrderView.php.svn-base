...
while ($line = mysql_fetch_array($strResult, MYSQL_ASSOC))
{
	...
	if ($arrAddress[2]<>""){
	echo $arrAddress[2];}
	echo "<br>" . $arrAddress[5] . "<br>" . $arrAddress[3] . "<br>" .$arrAddress[4] ."<br>" .$arrAddress[0] ."</font><br><br>";

	echo "<br><br><br><br>";
	echo "Order No:" . $strOrderNo ."<br><br>";
	echo "<tr><td>Date Ordered:</td><td>" . date ("D jS Y - G:i", strtotime($strOrderSubmitted)) . "</td></tr>";
	echo "<tr><td>Payment Recieved:</td><td>" . date ("D jS Y - G:i", strtotime($strIPNSubmitted)) . "</td></tr>";
	...
	{
		case "PAID":
			echo "<tr><td>Status:</td><td><select name='STATUS'><option value='REFUNDED'>REFUNDED</option><option value='PROBLEM'>PROBLEM</option><option value='PAID' selected='selected'>PAID</option><option value='PACKING'>PACKING</option><option value='SENT'>SENT</option></select><input type='submit' value='Submit'></td></tr>";
			break;
		case "INITIAL":
			echo "<tr><td>Status:</td><td><select name='STATUS'><option value='REFUNDED'>REFUNDED</option><option value='PROBLEM'>PROBLEM</option><option value='INITIAL' selected='selected'>INITIAL</option><option value='PAID'>PAID</option><option value='PACKING'>PACKING</option><option value='SENT'>SENT</option><input type='submit' value='Submit'></select></td></tr>";
			break;
		case "PACKING":
			echo "<tr><td>Status:</td><td><select name='STATUS'><option value='REFUNDED'>REFUNDED</option><option value='PROBLEM'>PROBLEM</option><option value='PAID'>PAID</option><option value='PACKING'  selected='selected'>PACKING</option><option value='SENT'>SENT</option></select><input type='submit' value='Submit'></td></tr>";
			break;
		case "SENT":
 			echo "<tr><td>Status:</td><td><select name='STATUS'><option value='REFUNDED'>REFUNDED</option><option value='PROBLEM'>PROBLEM</option><option value='PAID'>PAID</option><option value='PACKING'>PACKING</option><option value='SENT'  selected='selected'>SENT</option></select><input type='submit' value='Submit'></td></tr>";
 			break;
		case "PROBLEM":
			echo "<tr><td>Status:</td><td><select name='STATUS'><option value='REFUNDED'>REFUNDED</option><option value='PROBLEM' selected='selected'>PROBLEM</option><option value='PAID'>PAID</option><option value='PACKING'>PACKING</option><option value='SENT'>SENT</option></select><input type='submit' value='Submit'></td></tr>";
			break;
		case "REFUNDED":
			echo "<tr><td>Status:</td><td><select name='STATUS'><option value='REFUNDED' selected='selected'>REFUNDED</option><option value='PROBLEM'>PROBLEM</option><option value='PAID'>PAID</option><option value='PACKING'>PACKING</option><option value='SENT'>SENT</option></select><input type='submit' value='Submit'></td></tr>";
			break;
		default:
			break;
