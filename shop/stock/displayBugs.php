  ...
  <tr> 
    <td> 
      <div align="center"> 
        ...
        <center>
          <font size="3" face="Verdana, Arial, Helvetica, sans-serif"><b>S u b 
          m i t </b>B u g . . . . .</font><font size="3"></font> 
        </center>
      </div>
    </td>
  </tr>
...
echo "<tr> <td class='first' bgcolor='#9999CC'>Issue No</td> <td class='first' bgcolor='#9999CC'>Date Submitted</td> <td class='first' bgcolor='#9999CC'>Issue</td><td class='first' bgcolor='#9999CC'>Priority</td> <td class='first' bgcolor='#9999CC'>Fixed</td> </tr>\n";
...
while ($line = mysql_fetch_array($strResult, MYSQL_ASSOC) )
{
	...
	foreach ($line as $col_value)
	{
		...
		//even number
		{
			...
			if ($j==4)
			{
			echo "\t\t<td class='seconda'>" . $col_value . "</td>\n\t\t<td class='seconda'> <input type='radio' name='fix' value='" . $line["IssueNo"] . "'></td>\n";
			}
			else
			{
			echo "\t\t<td class='seconda'>" . $col_value . "</td>\n";
		...
		else
		{
			...
			if ($j==4)
			{
			echo "\t\t<td class='secondb'>" . $col_value . "</td>\n\t\t<td class='secondb'> <input type='radio' name='fix' value='" . $line["IssueNo"] . "'></td>\n";
			}
			else
			{
			echo "\t\t<td class='secondb'>" . $col_value . "</td>\n";
