  ...
  <tr>
    <td align="center"> 
      <?php
			...
			echo "
			<tr>
				<td class='first' bgcolor='#9999CC'>&nbsp;StockID &nbsp;</td><td class='first' bgcolor='#9999CC'>&nbsp; Name &nbsp;</td><td class='first' bgcolor='#9999CC'>&nbsp; Small Description &nbsp;</td><td class='first' bgcolor='#9999CC'> &nbsp;RRP&nbsp; </td>
			...
			while ($line = mysql_fetch_array($strResult, MYSQL_ASSOC))
			{
				...
				foreach ($line as $col_value)
				{
					...
					if ($i % 2 == 0)
					{
						//even number
						if ($j == 1)
							echo "\t\t<td class='seconda'><a href='update.php?stockID=" . $line["stockID"] . "'>$col_value</a></td>\n";
						else
						{
					...
					else
					{
						//odd number
						if ($j == 1)
							echo "\t\t<td class='secondb'><a href='update.php?stockID=" . $line["stockID"] . "'>$col_value</a></td>\n";
						else
						{
