...
//subCategory menu ************************************************************************************
	...
	$strQuery3 = "SELECT distinct Category, CategoryTag, count(NoOfItems) FROM `tblItem` where SubjectTag='" . $strSTag. "' and VersionTag='" . $strVTag . "' group by Category having (count(NoOfItems)>0) order by CategoryTag";
